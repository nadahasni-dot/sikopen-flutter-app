...
class PengajuanCutiScreen extends StatefulWidget {
  PengajuanCutiScreen({Key key}) : super(key: key);
...
class _PengajuanCutiScreenState extends State<PengajuanCutiScreen> {
  var _formKey;
  List cuti = ["Cuti tahunan", "Cuti Besar"];
  List<DropdownMenuItem<String>> _dropDownCutiItems;
  String _currentCuti;
  ...
  @override
  void initState() {
    _dropDownCutiItems = getDropDownMenuItems();
    _currentCuti = _dropDownCutiItems[0].value;
